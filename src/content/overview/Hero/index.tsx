        ...
        <Grid item md={10} lg={8} mx="auto">
          ...
          <Grid container spacing={3} mt={5}>
            ...
            <Grid item md={6}>
              ...
              <Typography variant="h4">
                <Box sx={{ pb: 2 }}><b>Built with Typescript</b></Box><Typography component="span" variant="subtitle2"> - This project features a modern technology stack and is built with React + Typescript.</Typography>
              </Typography>
            </Grid>
          </Grid>
        </Grid>
