...
function Knob(props) {
    ...
    var knobElement = (React.createElement("div", { ref: refElement, onMouseDown: knobArea && knobArea.handleOnMouseDown, onTouchStart: knobArea && knobArea.handleOnTouchStart, onKeyDown: knobArea && knobArea.handleOnKeyDown, onFocus: knobArea && knobArea.handleOnFocus, onBlur: knobArea && knobArea.handleOnBlur, style: activeStyle, tabIndex: 0, "aria-valuenow": props.value, "aria-valuemin": props.min, "aria-valuemax": props.max, "aria-valuetext": props.ariaValueText, "aria-labelledby": props.ariaLabelledBy }, props.children));
    if (errorContent) {
        return (React.createElement(KnobErrorWrap, { error: errorContent, diameter: props.diameter }, knobElement));
    }
    return knobElement;
}
...
function SkinWrap(props) {
    ...
    var activeStyle = __assign(__assign({}, defaultStyle), userStyle);
    return React.createElement("div", { style: activeStyle }, props.children);
}
...
function Basic(props) {
    var _a = useState(0), angle = _a[0], setAngle = _a[1];
    ...
    return (React.createElement(SkinWrap, { style: props.style },
        React.createElement(Knob, { diameter: props.diameter, value: props.value, min: props.min, max: props.max, step: props.step, spaceMaxFromZero: props.spaceMaxFromZero, ariaLabelledBy: props.ariaLabelledBy, ariaValueText: props.ariaValueText, knobStyle: __assign({ cursor: 'pointer' }, props.knobStyle), onAngleChange: angleChangeHandler, onInteractionChange: interactionChangeHandler, onValueChange: props.onValueChange },
            React.createElement(React.Fragment, null,
                React.createElement("svg", { viewBox: "0 0 166.56 166.56", transform: "rotate(" + angle + ")", style: { transform: "rotate(" + angle + "deg)" } },
                    React.createElement("defs", null,
                        React.createElement("linearGradient", { id: "a" },
                            React.createElement("stop", { offset: "0", stopColor: gradientStart, stopOpacity: "1" }),
                            React.createElement("stop", { offset: "1", stopColor: gradientEnd, stopOpacity: "1" })),
                        React.createElement("filter", { id: "b", width: "1.11", height: "1.11", x: "-0.055", y: "-0.055", colorInterpolationFilters: "sRGB" },
                            React.createElement("feGaussianBlur", { stdDeviation: "3.45" })),
                        React.createElement("linearGradient", { id: "c", x1: "140.985", x2: "63.122", y1: "98.751", y2: "202.317", gradientTransform: "translate(-75.643 -328.104)", gradientUnits: "userSpaceOnUse", xlinkHref: "#a" })),
                    React.createElement("g", { fillOpacity: "1", transform: "translate(-21.72 -65.22)" },
                        React.createElement("circle", { cx: "105", cy: "148.5", r: "75", fill: "#ccc", stroke: "none", strokeDasharray: "none", strokeMiterlimit: "4", strokeOpacity: "1", strokeWidth: "17.106", filter: "url(#b)", opacity: "1" }),
                        React.createElement("circle", { cx: "29.357", cy: "-179.604", r: "70", fill: "url(#c)", stroke: borderColor, strokeDasharray: "none", strokeMiterlimit: "4", strokeOpacity: "1", strokeWidth: "1", opacity: "1", transform: "rotate(135.448)" }),
                        React.createElement("circle", { cx: "105.083", cy: "88.628", r: "4.443", fill: notchAndText, stroke: "#b1b1b1", strokeDasharray: "none", strokeMiterlimit: "4", strokeOpacity: "1", strokeWidth: "0.551", opacity: "1" }))),
                React.createElement("div", { style: {
                        width: '100%',
                        textAlign: 'center',
        ...
        React.createElement(Knob, { diameter: props.diameter, value: props.value, min: props.min, max: props.max, step: props.step, spaceMaxFromZero: props.spaceMaxFromZero, ariaLabelledBy: props.ariaLabelledBy, ariaValueText: props.ariaValueText, knobStyle: __assign({ cursor: 'pointer' }, props.knobStyle), onAngleChange: angleChangeHandler, onInteractionChange: interactionChangeHandler, onValueChange: props.onValueChange },
            React.createElement(React.Fragment, null,
                React.createElement("svg", { viewBox: "0 0 100 100", transform: "rotate(" + angle + ")", style: { transform: "rotate(" + angle + "deg)" } },
                    ...
                    React.createElement("path", { fill: bgrColor, d: "M50 4A46 46 0 004 50a46 46 0 0046 46 46 46 0 0046-46A46 46 0 0050 4zm0 2.141a4.276 4.276 0 014.276 4.277A4.276 4.276 0 0150 14.694a4.276 4.276 0 01-4.276-4.276A4.276 4.276 0 0150 6.141z" })),
                React.createElement("div", { style: {
                        width: '100%',
                        textAlign: 'center',
...
function White(props) {
    ...
    return (React.createElement(SkinWrap, { style: props.style },
        React.createElement(Knob, { diameter: props.diameter, value: props.value, min: props.min, max: props.max, step: props.step, spaceMaxFromZero: props.spaceMaxFromZero, ariaLabelledBy: props.ariaLabelledBy, ariaValueText: props.ariaValueText, knobStyle: __assign({ cursor: 'pointer' }, props.knobStyle), onAngleChange: angleChangeHandler, onInteractionChange: interactionChangeHandler, onValueChange: props.onValueChange },
            React.createElement(React.Fragment, null,
                React.createElement("svg", { viewBox: "0 0 62.463 62.463" },
                    React.createElement("defs", null,
                        React.createElement("linearGradient", { id: "prefix__c" },
                            React.createElement("stop", { offset: 0, stopColor: "#fff" }),
                            React.createElement("stop", { offset: 1, stopColor: "#b0b0b0" })),
                        React.createElement("linearGradient", { id: "prefix__a" },
                            React.createElement("stop", { offset: 0, stopColor: "#939393" }),
                            React.createElement("stop", { offset: 1, stopColor: "#f0f0f0", stopOpacity: 0 })),
                        React.createElement("linearGradient", { id: "prefix__b" },
                            React.createElement("stop", { offset: 0, stopColor: "#b0b0b0" }),
                            React.createElement("stop", { offset: 1, stopColor: "#fdfdfd" })),
                        React.createElement("linearGradient", { gradientTransform: "matrix(.84848 0 0 .84848 -25.569 29.664)", gradientUnits: "userSpaceOnUse", y2: 136.304, x2: 200.519, y1: 175.459, x1: 244.552, id: "prefix__e", xlinkHref: "#prefix__b" }),
                        React.createElement("linearGradient", { gradientUnits: "userSpaceOnUse", y2: 196.319, x2: 143.659, y1: 184.184, x1: 133.863, id: "prefix__d", xlinkHref: "#prefix__c" })),
                    React.createElement("g", { transform: "translate(-131.196 -134.336)" },
                        React.createElement("g", { transform: "translate(-442.372 -663.575) scale(4.37185)" },
                            React.createElement("circle", { cx: 138.339, cy: 189.655, r: 7.144, fill: bgrColor }),
                            React.createElement("path", { d: "M138.34 182.511a7.144 7.144 0 00-7.144 7.144 7.144 7.144 0 007.143 7.144 7.144 7.144 0 007.144-7.144 7.144 7.144 0 00-7.144-7.144zm0 .53a6.615 6.615 0 016.614 6.614 6.615 6.615 0 01-6.615 6.614 6.615 6.615 0 01-6.614-6.614 6.615 6.615 0 016.614-6.615z", fill: "url(#prefix__d)" }),
                            React.createElement("circle", { cx: 138.339, cy: 189.655, r: 6.35, fill: "#fff" })),
                        React.createElement("circle", { r: 14.583, cy: 192.949, cx: 149.253, fill: "none" }),
                        React.createElement("circle", { cy: 165.567, cx: 162.427, fill: "#f0f0f0", r: 27.151 })),
                    React.createElement("g", { transform: "translate(" + 62.463 / 2 + " " + 62.463 /
                        ...
                        return (React.createElement("rect", { key: key, id: "r" + index, fill: fill, width: width, height: height, x: x, y: y, transform: "rotate(" + (index *
...
function Silver(props) {
    var _a = useState(0), angle = _a[0], setAngle = _a[1];
    var _b = useState(uniqClassName + "-bgr"), bgrClass = _b[0], setBgrClass = _b[1];
    var angleChangeHandler = composeTwo(setAngle, props.onAngleChange);
        ...
        React.createElement(Knob, { diameter: props.diameter + glowSpacing, value: props.value, min: props.min, max: props.max, step: props.step, spaceMaxFromZero: props.spaceMaxFromZero, ariaLabelledBy: props.ariaLabelledBy, ariaValueText: props.ariaValueText, knobStyle: __assign({ cursor: 'pointer' }, props.knobStyle), onAngleChange: angleChangeHandler, onInteractionChange: interactionChangeHandler, onValueChange: props.onValueChange },
            React.createElement(React.Fragment, null,
                ...
                React.createElement("div", { style: {
                    ...
                    React.createElement("div", { className: bgrClass, style: {
                            width: props.diameter + "px",
                            height: props.diameter + "px",
                            borderRadius: props.diameter / 2 + "px",
                        } }),
                    React.createElement("div", { className: uniqClassName + "-rot", style: {
                        ...
                        React.createElement("div", { className: uniqClassName + "-notch", style: {
                                left: (props.diameter - 24) / 2 + "px",
                            } })),
                    React.createElement("div", { className: uniqClassName + "-text", style: {
                            fontSize: Math.ceil(props.diameter / 4) + "px",
                        } }, props.value)))),
        props.children));
}
...
function Donut(props) {
    var _a = useState(0), angle = _a[0], setAngle = _a[1];
    var _b = useState(uniqClassName$1 + "-center"), centerClass = _b[0], setCenterClass = _b[1];
    var angleChangeHandler = composeTwo(setAngle, props.onAngleChange);
    var interactionChangeHandler = composeTwo(function (isInteracting) {
        isInteracting
        ...
        React.createElement(Knob, { diameter: props.diameter, value: props.value, min: props.min, max: props.max, step: props.step, spaceMaxFromZero: props.spaceMaxFromZero, ariaLabelledBy: props.ariaLabelledBy, ariaValueText: props.ariaValueText, knobStyle: __assign({ cursor: 'pointer' }, props.knobStyle), onAngleChange: angleChangeHandler, onInteractionChange: interactionChangeHandler, onValueChange: props.onValueChange },
            React.createElement(React.Fragment, null,
                ...
                React.createElement("div", { style: {
                    ...
                    React.createElement("div", { className: uniqClassName$1, style: {
                            width: props.diameter + "px",
                            height: props.diameter + "px",
                            background: colorBgr,
                        } },
                        React.createElement("div", { className: uniqClassName$1 + "-slice-one", style: {
                                clip: "rect(0 " + props.diameter + "px " + props.diameter / 2 + "px 0)",
                                transform: "rotate(" + angleOne + "deg)",
                                background: colorOne,
                            } }),
                        React.createElement("div", { className: uniqClassName$1 + "-slice-two", style: {
                                clip: "rect(0 " + props.diameter / 2 + "px " + props.diameter + "px 0)",
                                transform: "rotate(" + angleTwo + "deg)",
                                background: colorTwo,
                            } }),
                        React.createElement("div", { className: centerClass, style: {
                    ...
                    React.createElement("div", { className: uniqClassName$1 + "-text", style: {
                            color: donutColor,
                            fontSize: Math.ceil(props.diameter / 4) + "px",
                        } }, props.value)))),
        props.children));
...
export default Knob;
export { Basic, Donut, HighContrast, Silver, SkinWrap, White, composeTwo };
//# sourceMappingURL=react-dial-knob.es.js.map
