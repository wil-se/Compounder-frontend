...
declare const wrapSkinComponent: (SkinComponent: React.StatelessComponent<SkinProps<{} | DonutTheme | BasicTheme | HighContrastTheme | WhiteTheme>>, defaults?: DefaultValues, themeProvider?: () => DonutTheme | BasicTheme | HighContrastTheme | WhiteTheme) => Story;
