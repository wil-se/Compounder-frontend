(function (global, factory) {
    ...
    (global = global || self, factory(global.ReactDialKnob = {}, global.React));
    ...
    ***************************************************************************** */
    ...
    function Knob(props) {
        ...
        var knobElement = (React__default.createElement("div", { ref: refElement, onMouseDown: knobArea && knobArea.handleOnMouseDown, onTouchStart: knobArea && knobArea.handleOnTouchStart, onKeyDown: knobArea && knobArea.handleOnKeyDown, onFocus: knobArea && knobArea.handleOnFocus, onBlur: knobArea && knobArea.handleOnBlur, style: activeStyle, tabIndex: 0, "aria-valuenow": props.value, "aria-valuemin": props.min, "aria-valuemax": props.max, "aria-valuetext": props.ariaValueText, "aria-labelledby": props.ariaLabelledBy }, props.children));
        if (errorContent) {
            return (React__default.createElement(KnobErrorWrap, { error: errorContent, diameter: props.diameter }, knobElement));
        }
        return knobElement;
    }
    ...
    function SkinWrap(props) {
        ...
        var activeStyle = __assign(__assign({}, defaultStyle), userStyle);
        return React__default.createElement("div", { style: activeStyle }, props.children);
    }
    ...
    function Basic(props) {
        ...
        return (React__default.createElement(SkinWrap, { style: props.style },
            React__default.createElement(Knob, { diameter: props.diameter, value: props.value, min: props.min, max: props.max, step: props.step, spaceMaxFromZero: props.spaceMaxFromZero, ariaLabelledBy: props.ariaLabelledBy, ariaValueText: props.ariaValueText, knobStyle: __assign({ cursor: 'pointer' }, props.knobStyle), onAngleChange: angleChangeHandler, onInteractionChange: interactionChangeHandler, onValueChange: props.onValueChange },
                React__default.createElement(React__default.Fragment, null,
                    React__default.createElement("svg", { viewBox: "0 0 166.56 166.56", transform: "rotate(" + angle + ")", style: { transform: "rotate(" + angle + "deg)" } },
                        React__default.createElement("defs", null,
                            React__default.createElement("linearGradient", { id: "a" },
                                React__default.createElement("stop", { offset: "0", stopColor: gradientStart, stopOpacity: "1" }),
                                React__default.createElement("stop", { offset: "1", stopColor: gradientEnd, stopOpacity: "1" })),
                            React__default.createElement("filter", { id: "b", width: "1.11", height: "1.11", x: "-0.055", y: "-0.055", colorInterpolationFilters: "sRGB" },
                                React__default.createElement("feGaussianBlur", { stdDeviation: "3.45" })),
                            React__default.createElement("linearGradient", { id: "c", x1: "140.985", x2: "63.122", y1: "98.751", y2: "202.317", gradientTransform: "translate(-75.643 -328.104)", gradientUnits: "userSpaceOnUse", xlinkHref: "#a" })),
                        React__default.createElement("g", { fillOpacity: "1", transform: "translate(-21.72 -65.22)" },
                            React__default.createElement("circle", { cx: "105", cy: "148.5", r: "75", fill: "#ccc", stroke: "none", strokeDasharray: "none", strokeMiterlimit: "4", strokeOpacity: "1", strokeWidth: "17.106", filter: "url(#b)", opacity: "1" }),
                            React__default.createElement("circle", { cx: "29.357", cy: "-179.604", r: "70", fill: "url(#c)", stroke: borderColor, strokeDasharray: "none", strokeMiterlimit: "4", strokeOpacity: "1", strokeWidth: "1", opacity: "1", transform: "rotate(135.448)" }),
                            React__default.createElement("circle", { cx: "105.083", cy: "88.628", r: "4.443", fill: notchAndText, stroke: "#b1b1b1", strokeDasharray: "none", strokeMiterlimit: "4", strokeOpacity: "1", strokeWidth: "0.551", opacity: "1" }))),
                    React__default.createElement("div", { style: {
                            width: '100%',
                            textAlign: 'center',
    ...
    function HighContrast(props) {
        ...
        return (React__default.createElement(SkinWrap, { style: props.style },
            React__default.createElement(Knob, { diameter: props.diameter, value: props.value, min: props.min, max: props.max, step: props.step, spaceMaxFromZero: props.spaceMaxFromZero, ariaLabelledBy: props.ariaLabelledBy, ariaValueText: props.ariaValueText, knobStyle: __assign({ cursor: 'pointer' }, props.knobStyle), onAngleChange: angleChangeHandler, onInteractionChange: interactionChangeHandler, onValueChange: props.onValueChange },
                React__default.createElement(React__default.Fragment, null,
                    React__default.createElement("svg", { viewBox: "0 0 100 100", transform: "rotate(" + angle + ")", style: { transform: "rotate(" + angle + "deg)" } },
                        React__default.createElement("path", { fill: bgrColor, d: "M50 0A50 50 0 000 50a50 50 0 0050 50 50 50 0 0050-50A50 50 0 0050 0zm0 2a48 48 0 0148 48 48 48 0 01-48 48A48 48 0 012 50 48 48 0 0150 2z" }),
                        React__default.createElement("path", { fill: bgrColor, d: "M50 4A46 46 0 004 50a46 46 0 0046 46 46 46 0 0046-46A46 46 0 0050 4zm0 2.141a4.276 4.276 0 014.276 4.277A4.276 4.276 0 0150 14.694a4.276 4.276 0 01-4.276-4.276A4.276 4.276 0 0150 6.141z" })),
                    React__default.createElement("div", { style: {
                            width: '100%',
                            textAlign: 'center',
    ...
    function White(props) {
        ...
        return (React__default.createElement(SkinWrap, { style: props.style },
            React__default.createElement(Knob, { diameter: props.diameter, value: props.value, min: props.min, max: props.max, step: props.step, spaceMaxFromZero: props.spaceMaxFromZero, ariaLabelledBy: props.ariaLabelledBy, ariaValueText: props.ariaValueText, knobStyle: __assign({ cursor: 'pointer' }, props.knobStyle), onAngleChange: angleChangeHandler, onInteractionChange: interactionChangeHandler, onValueChange: props.onValueChange },
                React__default.createElement(React__default.Fragment, null,
                    React__default.createElement("svg", { viewBox: "0 0 62.463 62.463" },
                        React__default.createElement("defs", null,
                            React__default.createElement("linearGradient", { id: "prefix__c" },
                                React__default.createElement("stop", { offset: 0, stopColor: "#fff" }),
                                React__default.createElement("stop", { offset: 1, stopColor: "#b0b0b0" })),
                            React__default.createElement("linearGradient", { id: "prefix__a" },
                                React__default.createElement("stop", { offset: 0, stopColor: "#939393" }),
                                React__default.createElement("stop", { offset: 1, stopColor: "#f0f0f0", stopOpacity: 0 })),
                            React__default.createElement("linearGradient", { id: "prefix__b" },
                                React__default.createElement("stop", { offset: 0, stopColor: "#b0b0b0" }),
                                React__default.createElement("stop", { offset: 1, stopColor: "#fdfdfd" })),
                            React__default.createElement("linearGradient", { gradientTransform: "matrix(.84848 0 0 .84848 -25.569 29.664)", gradientUnits: "userSpaceOnUse", y2: 136.304, x2: 200.519, y1: 175.459, x1: 244.552, id: "prefix__e", xlinkHref: "#prefix__b" }),
                            React__default.createElement("linearGradient", { gradientUnits: "userSpaceOnUse", y2: 196.319, x2: 143.659, y1: 184.184, x1: 133.863, id: "prefix__d", xlinkHref: "#prefix__c" })),
                        React__default.createElement("g", { transform: "translate(-131.196 -134.336)" },
                            React__default.createElement("g", { transform: "translate(-442.372 -663.575) scale(4.37185)" },
                                React__default.createElement("circle", { cx: 138.339, cy: 189.655, r: 7.144, fill: bgrColor }),
                                React__default.createElement("path", { d: "M138.34 182.511a7.144 7.144 0 00-7.144 7.144 7.144 7.144 0 007.143 7.144 7.144 7.144 0 007.144-7.144 7.144 7.144 0 00-7.144-7.144zm0 .53a6.615 6.615 0 016.614 6.614 6.615 6.615 0 01-6.615 6.614 6.615 6.615 0 01-6.614-6.614 6.615 6.615 0 016.614-6.615z", fill: "url(#prefix__d)" }),
                                React__default.createElement("circle", { cx: 138.339, cy: 189.655, r: 6.35, fill: "#fff" })),
                            React__default.createElement("circle", { r: 14.583, cy: 192.949, cx: 149.253, fill: "none" }),
                            React__default.createElement("circle", { cy: 165.567, cx: 162.427, fill: "#f0f0f0", r: 27.151 })),
                        React__default.createElement("g", { transform: "translate(" + 62.463 / 2 + " " + 62.463 /
                                2 + ") scale(0.45) rotate(-90)" }, Array.from(new Array(numNotches)).map(function (_, index) {
                            ...
                            return (React__default.createElement("rect", { key: key, id: "r" + index, fill: fill, width: width, height: height, x: x, y: y, transform: "rotate(" + (index *
            ...
            React__default.createElement(Knob, { diameter: props.diameter + glowSpacing, value: props.value, min: props.min, max: props.max, step: props.step, spaceMaxFromZero: props.spaceMaxFromZero, ariaLabelledBy: props.ariaLabelledBy, ariaValueText: props.ariaValueText, knobStyle: __assign({ cursor: 'pointer' }, props.knobStyle), onAngleChange: angleChangeHandler, onInteractionChange: interactionChangeHandler, onValueChange: props.onValueChange },
                React__default.createElement(React__default.Fragment, null,
                    ...
                    React__default.createElement("div", { style: {
                        ...
                        React__default.createElement("div", { className: bgrClass, style: {
                                width: props.diameter + "px",
                                height: props.diameter + "px",
                                borderRadius: props.diameter / 2 + "px",
                            } }),
                        React__default.createElement("div", { className: uniqClassName + "-rot", style: {
                            ...
                            React__default.createElement("div", { className: uniqClassName + "-notch", style: {
                                    left: (props.diameter - 24) / 2 + "px",
                                } })),
                        React__default.createElement("div", { className: uniqClassName + "-text", style: {
                                fontSize: Math.ceil(props.diameter / 4) + "px",
                            } }, props.value)))),
            props.children));
    }
            ...
            React__default.createElement(Knob, { diameter: props.diameter, value: props.value, min: props.min, max: props.max, step: props.step, spaceMaxFromZero: props.spaceMaxFromZero, ariaLabelledBy: props.ariaLabelledBy, ariaValueText: props.ariaValueText, knobStyle: __assign({ cursor: 'pointer' }, props.knobStyle), onAngleChange: angleChangeHandler, onInteractionChange: interactionChangeHandler, onValueChange: props.onValueChange },
                React__default.createElement(React__default.Fragment, null,
                    ...
                    React__default.createElement("div", { style: {
                        ...
                        React__default.createElement("div", { className: uniqClassName$1, style: {
                                width: props.diameter + "px",
                                height: props.diameter + "px",
                                background: colorBgr,
                            } },
                            React__default.createElement("div", { className: uniqClassName$1 + "-slice-one", style: {
                                    clip: "rect(0 " + props.diameter + "px " + props.diameter / 2 + "px 0)",
                                    transform: "rotate(" + angleOne + "deg)",
                                    background: colorOne,
                                } }),
                            React__default.createElement("div", { className: uniqClassName$1 + "-slice-two", style: {
                                    clip: "rect(0 " + props.diameter / 2 + "px " + props.diameter + "px 0)",
                                    transform: "rotate(" + angleTwo + "deg)",
                                    background: colorTwo,
                                } }),
                            React__default.createElement("div", { className: centerClass, style: {
                        ...
                        React__default.createElement("div", { className: uniqClassName$1 + "-text", style: {
                                color: donutColor,
                                fontSize: Math.ceil(props.diameter / 4) + "px",
                            } }, props.value)))),
            props.children));
